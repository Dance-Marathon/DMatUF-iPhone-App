...
@interface DMFirstViewController : GAITrackedViewController<UIWebViewDelegate> {
    NSMutableData *httpResponse;
    __weak IBOutlet UIActivityIndicatorView *activityIndicator;
}
@property (strong, nonatomic) IBOutlet UIWebView *mainView;
@property (strong, nonatomic) IBOutlet UIButton *linedanceButton;
